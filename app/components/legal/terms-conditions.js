...
// styles
import { TermsConditionsWrapper } from './styles'
...
const TermsConditions = () => (
  <TermsConditionsWrapper>
    ...
    <p>
      ...
      and Flagis mobile application (the "Service").
    </p>
    ...
    <p>
      ...
      renew under the exact same conditions unless you cancel it or Flagis
      s.r.o. cancels it. You may cancel your Subscription renewal either through
      your online account management page or by contacting Flagis s.r.o.
      customer support team.
    </p>

    <p>
      A valid payment method, including credit card or PayPal, is required to
      process the payment for your Subscription. You shall provide Flagis s.r.o.
      ...
      authorize Flagis s.r.o. to charge all Subscription fees incurred through
      your account to any such payment instruments.
    </p>

    <p>
      Should automatic billing fail to occur for any reason, Flagis s.r.o. will
    ...
    <p>
      Flagis s.r.o. may, at its sole discretion, offer a Subscription with a
    ...
    <p>
      ...
      Trial, you will not be charged by Flagis s.r.o. until the Free Trial has
    ...
    <p>
      At any time and without notice, Flagis s.r.o. reserves the right to (i)
    ...
    <p>
      Flagis s.r.o., in its sole discretion and at any time, may modify the
    ...
    <p>
      Flagis s.r.o. will provide you with a reasonable prior notice of any
    ...
    <p>
      ...
      property of Flagis s.r.o. and its licensors. The Service is protected by
      copyright, trademark, and other laws of both the Czech Republic and
    ...
    <p>
      ...
      are not owned or controlled by Flagis s.r.o..
    </p>

    <p>
      Flagis s.r.o. has no control over, and assumes no responsibility for, the
      content, privacy policies, or practices of any third party web sites or
      services. You further acknowledge and agree that Flagis s.r.o. shall not
    ...
    <p>
      In no event shall Flagis s.r.o., nor its directors, employees, partners,
    ...
    <p>
      Flagis s.r.o. its subsidiaries, affiliates, and its licensors do not
    ...
    <p>
      ...
      Czech Republic, without regard to its conflict of law provisions.
    </p>
