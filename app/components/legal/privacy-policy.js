...
// styles
import { PrivacyPolicyWrapper } from './styles'
...
const PrivacyPolicy = () => (
  <PrivacyPolicyWrapper>
    ...
    <h2>Use of Data</h2>
    <p>Flagis s.r.o. uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are from the European Economic Area (EEA), Flagis s.r.o. legal
    ...
    <p>Flagis s.r.o. may process your Personal Data because:</p>
    <ul>
    ...
    <p>
      Flagis s.r.o. will retain your Personal Data only for as long as is
    ...
    <p>
      Flagis s.r.o. will also retain Usage Data for internal analysis purposes.
    ...
    <p>
      ...
      Personal Data, to Czech Republic and process it there.
    </p>
    <p>
    ...
    <p>
      Flagis s.r.o. will take all the steps reasonably necessary to ensure that
    ...
    <p>
      If Flagis s.r.o. is involved in a merger, acquisition or asset sale, your
    ...
    <p>
      Under certain circumstances, Flagis s.r.o. may be required to disclose
    ...
    <p>
      Flagis s.r.o. may disclose your Personal Data in the good faith belief
      that such action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Flagis s.r.o.</li>
      <li>
    ...
    <p>
      ...
      certain data protection rights. Flagis s.r.o. aims to take reasonable
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          right to withdraw your consent at any time where Flagis s.r.o. relied
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          here: <a href="https://clicky.com/terms">https://clicky.com/terms</a>
        </p>
      </li>
      <li>
        <p>
          <strong>Statcounter</strong>
        </p>
        <p>
...
export default withTitle(PrivacyPolicy, titles.LEGAL_PRIVACY_POLICY)
