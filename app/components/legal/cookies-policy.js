...
// styles
import { CookiesPolicyWrapper } from './styles'
...
const CookiesPolicy = () => (
  <CookiesPolicyWrapper>
    ...
    <h2>How Flagis s.r.o. uses cookies</h2>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          authenticate users and prevent fraudulent use of user accounts. We may
          use these cookies to remember information that changes the way the
...
export default withTitle(CookiesPolicy, titles.LEGAL_COOKIES_POLICY)
