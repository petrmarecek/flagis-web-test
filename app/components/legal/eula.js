...
// styles
import { EulaWrapper } from './styles'
...
const Eula = () => (
  <EulaWrapper>
    ...
    <p>
      ...
      clicking the "I Agree" button, downloading or using Flagis
      ("Application").
    </p>
    ...
    <p>
      ...
      single entity) and Flagis s.r.o. and it governs your use of the
      Application made available to you by Flagis s.r.o..
    </p>
    ...
    <p>
      The Application is licensed, not sold, to you by Flagis s.r.o. for use
    ...
    <p>
      Flagis s.r.o. grants you a revocable, non-exclusive, non-transferable,
      limited license to download, install and use the Application solely for
      your personal, non-commercial purposes strictly in accordance with the
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          under the above section 'License'.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          of copyright or trademark) of Flagis s.r.o. or its affiliates,
    ...
    <p>
      ...
      shall remain, the sole and exclusive property of Flagis s.r.o..
    </p>
    ...
    <p>
      ...
      "Suggestions") provided by you to Flagis s.r.o. with respect to the
      Application shall remain the sole and exclusive property of Flagis s.r.o..
    </p>

    <p>
      Flagis s.r.o. shall be free to use, copy, modify, publish, or redistribute
    ...
    <p>
      Flagis s.r.o. reserves the right to modify, suspend or discontinue,
    ...
    <p>
      Flagis s.r.o. may from time to time provide enhancements or improvements
      to the features/functionality of the Application, which may include
      patches, bug fixes, updates, upgrades and other modifications ("Updates").
    </p>

    <p>
      Updates may modify or delete certain features and/or functionalities of
      the Application. You agree that Flagis s.r.o. has no obligation to (i)
    ...
    <p>
      You acknowledge and agree that Flagis s.r.o. shall not be responsible for
      any Third-Party Services, including their accuracy, completeness,
      timeliness, validity, copyright compliance, legality, decency, quality or
      any other aspect thereof. Flagis s.r.o. does not assume and shall not have
    ...
    <p>
      This Agreement shall remain in effect until terminated by you or Flagis
      s.r.o..
    </p>

    <p>
      Flagis s.r.o. may, in its sole discretion, at any time and for any or no
    ...
    <p>
      ...
      Flagis s.r.o., in the event that you fail to comply with any provision of
    ...
    <p>
      Termination of this Agreement will not limit any of Flagis s.r.o.'s rights
    ...
    <p>
      ...
      Application; (b) violation of this Agreement or any law or regulation; or
    ...
    <p>
      ...
      permitted under applicable law, Flagis s.r.o., on its own behalf and on
      ...
      practice. Without limitation to the foregoing, Flagis s.r.o. provides no
    ...
    <p>
      Without limiting the foregoing, neither Flagis s.r.o. nor any Flagis
      s.r.o.'s provider makes any representation or warranty of any kind,
      ...
      of Flagis s.r.o. are free of viruses, scripts, trojan horses, worms,
    ...
    <p>
      ...
      Flagis s.r.o. and any of its suppliers under any provision of this
    ...
    <p>
      ...
      Flagis s.r.o. or its suppliers be liable for any special, incidental,
      ...
      Application, third-party software and/or third-party hardware used with
      the Application, or otherwise in connection with any provision of this
      Agreement), even if Flagis s.r.o. or any supplier has been advised of the
    ...
    <p>
      Flagis s.r.o. reserves the right, at its sole discretion, to modify or
    ...
    <p>
      The laws of Czech Republic, excluding its conflicts of law rules, shall
    ...
    <p>
      The Agreement constitutes the entire agreement between you and Flagis
      s.r.o. regarding your use of the Application and supersedes all prior and
      contemporaneous written or oral agreements between you and Flagis s.r.o..
    </p>

    <p>
      You may be subject to additional terms and conditions that apply when you
      use or purchase other Flagis s.r.o.'s services, which Flagis s.r.o. will
...
export default withTitle(Eula, titles.LEGAL_EULA)
