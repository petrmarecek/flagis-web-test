...
const VerificationEmailContent = ({ location, verifyUser, isVerificationFailed }) => {
	useEffect(() => {
...
const mapStateToProps = state => ({ isVerificationFailed: getVerificationFailed(state) });

export default connect(mapStateToProps, mapDispatchToProps)(VerificationEmailContent);
