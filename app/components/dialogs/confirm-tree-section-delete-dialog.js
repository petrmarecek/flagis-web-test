...
export default class ConfirmTreeSectionDeleteDialog extends DialogBase {
  static propTypes = {
  ...
  render() {
    return (
      <div className="dialog tree-item-tag-delete" ref="dialogWin">
        ...
        <form className="common-form" onSubmit={this.handleDelete}>
          <div className="dialog__content dialog__content--one-item">
            Do you really want to delete the filter group?
          </div>
