...
export default class ConfirmContactDeleteDialog extends DialogBase {
  ...
  handleDelete = () => {
    this.props.onDelete(this.props.data.contact)
    this.props.onHide()
  }

  render() {
    return (
      <div className="dialog contact-delete" ref="dialogWin">
        <Icon
        ...
        <form
          ...
          <div className="dialog__content dialog__content--one-item">
            Do you really want to delete the contact {this.props.data.contact.email}?
          </div>
