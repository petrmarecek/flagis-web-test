export const APP_STATE = {
  ...
  SET_PRIMARY_HIDDEN_NAVIGATION_ANIMATION:
    'APP-STATE/SET_PRIMARY_HIDDEN_NAVIGATION_ANIMATION',
  DESELECT_PRIMARY_HIDDEN_NAVIGATION_ANIMATION:
    'APP-STATE/DESELECT_PRIMARY_HIDDEN_NAVIGATION_ANIMATION',
...
export const setPrimaryHiddenNavigationAnimation = () => ({
  type: APP_STATE.SET_PRIMARY_HIDDEN_NAVIGATION_ANIMATION,
})

export const deselectPrimaryHiddenNavigationAnimation = () => ({
  type: APP_STATE.DESELECT_PRIMARY_HIDDEN_NAVIGATION_ANIMATION,
})
