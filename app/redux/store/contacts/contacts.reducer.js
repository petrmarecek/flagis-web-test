...
export default typeToReducer(
  {
    ...
    [CONTACTS.SELECT]: (state, action) =>
      state.setIn(['current'], action.payload.contactId),

    [CONTACTS.DESELECT]: state => state.set('current', null),

    [CONTACTS.UPDATE_SEARCH]: (state, action) =>
