...
export default function* root() {
  yield all([
    ...
    takeLatest(AUTH.SIGN_UP, auth.registerUser),
    takeLatest(AUTH.CONTROL_REDIRECT_SIGN_IN, auth.controlRedirectSignIn),
    takeLatest(AUTH.INIT_EMAIL, auth.initEmail),
    takeLatest(AUTH.CONTROL_DEFAULT_REDIRECT, auth.controlDefaultRedirect),
    ...
    takeEvery(TASKS.PREPARE_DELETE, task.prepareDeleteTask),
    ...
    takeEvery(TASKS_MENU.TOGGLE_FILTER, taskMenu.toggleFilter),
    ...
    takeEvery(TAGS.PREPARE_DELETE, tag.prepareDeleteTag),
    ...
    takeEvery(CONTACTS.PREPARE_DELETE, contact.prepareDeleteContact),
